...
export type NotificationType = 'update' | 'comment' | 'alert' | 'info';
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    case_id: 'CA-NK82-EJ1E',      // real DB caseId for navigation
    type: 'update',
    update_id: 'upd_01a',
    title: 'Official Update: CA-NK82-EJ1E',
  ...
  },
  {
    id: 'notif_02',
    user_id: 'current_user',
    case_id: 'CA-Z8GK-G57C',      // real DB caseId for navigation
    type: 'comment',
    update_id: 'upd_02a',
    title: 'New comment on CA-Z8GK-G57C',
